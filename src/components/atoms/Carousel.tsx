    ...
    <div>
      <div className="flex flex-col items-center max-w-64 relative">
        <div className="flex flex-row items-center justify-between h-full w-full absolute opacity-0 hover:opacity-100 duration-100">
          <button
            className="cursor-pointer px-2 h-full bg-gradient-to-r from-black/50 to-black/0"
            onClick={() =>
              setCurrentIndex(
          ...
          <button
            className="cursor-pointer px-2 h-full bg-gradient-to-l from-black/50 to-black/0"
            onClick={() =>
              setCurrentIndex(
      ...
      <div className="flex flex-row justify-center gap-1 mt-2">
        {items.map((_, index) => {
          return (
            <button
              className={`${index === currentIndex ? "bg-white" : ""} hover:bg-neutral-500 duration-100 border-white border-2 rounded-full min-w-8 md:min-w-3 aspect-square cursor-pointer`}
